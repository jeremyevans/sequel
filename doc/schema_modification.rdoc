...
TrueClass or FalseClass, they are treated the same way (ruby doesn't have a Boolean class). Also note that whether you specify DateTime or Time types, the value will be loaded from the database as a Time object.
