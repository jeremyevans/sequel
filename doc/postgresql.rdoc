...
=== Creating/Dropping Property Graphs (PostgreSQL 19+)

Sequel supports +create_property_graph+ and +drop_property_graph+ for creating and dropping property graphs:
