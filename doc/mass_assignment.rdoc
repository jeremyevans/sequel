...
Note that if you alias a primary key setter method, or define a setter method that calls the primary key setter method, you can still set the primary key value via mass assignment. It's probably best not do to that.
