...
Execute it as follows:
  ...
  DB.call_sproc(:SequelTest, {:args => ['Input String', :output]})
...
SQL type:
  ...
  DB.call_sproc(:SequelTest, {:args => ['Input String', [:output, 'int']]})
...
in the parameter list. To name the output variable, include their name:
  ...
  DB.call_sproc(:SequelTest, {:args => ['Input String', [:output, nil, 'Output']]})
