...
describe Sequel::Model::Relationship do
  describe "intance methods" do
    before :each do
      class Post; end
      @one = Sequel::Model::Relationship.new Post, :one, :author, {}
      @many = Sequel::Model::Relationship.new Post, :many, :comments, {:force => true}
