...
describe "Model#before_create && Model#after_create" do
  ...
  deprecated "should be called around new record creation" do
  ...
  deprecated ".create should cancel the save and raise an error if before_create calls cancel_action and raise_on_save_failure is true" do
  ...
  deprecated ".create should cancel the save and return nil if before_create calls cancel_action and raise_on_save_failure is false" do
...
describe "Model#before_update && Model#after_update" do
  ...
  deprecated "should be called around record update" do
  ...
  deprecated "#save should cancel the save and raise an error if before_update calls cancel_action and raise_on_save_failure is true" do
  ...
  deprecated "#save should cancel the save and return nil if before_update calls cancel_action and raise_on_save_failure is false" do
    @c.send(:define_method, :before_update){cancel_action}
    @c.raise_on_save_failure = false
    @c.load(:id => 2233).save.must_be_nil
    DB.sqls.must_equal []
...
describe "Model#before_save && Model#after_save" do
  ...
  deprecated "should be called around record creation" do
    @c.send(:define_method, :before_save){DB << "BLAH before"}
    @c.set_primary_key :x
  ...
  deprecated "#save should cancel the save and raise an error if before_save calls cancel_action and raise_on_failure option is true" do
  ...
  deprecated "#save should cancel the save and return nil if before_save calls cancel_action and raise_on_save_failure is false" do
    @c.send(:define_method, :before_save){cancel_action}
    @c.raise_on_save_failure = false
    @c.load(:id => 2233).save.must_be_nil
    DB.sqls.must_equal []
  ...
  deprecated "#save should have a raised exception reference the model instance" do
    @c.send(:define_method, :before_save){false}
...
describe "Model#before_destroy && Model#after_destroy" do
  ...
  deprecated "should be called around record destruction" do
  ...
  deprecated "#destroy should cancel the destroy and raise an error if before_destroy calls cancel_action and raise_on_save_failure is true" do
  ...
  deprecated "#destroy should cancel the destroy and return nil if before_destroy calls cancel_action and raise_on_save_failure is false" do
    @c.send(:define_method, :before_destroy){cancel_action; true}
    @c.raise_on_save_failure = false
    @c.load(:id => 2233).destroy.must_be_nil
    DB.sqls.must_equal []
...
describe "Model#before_validation && Model#after_validation" do
  ...
  deprecated "should be called around validation" do
  ...
  deprecated "should be called when calling save" do
    @c.send(:define_method, :before_validation){DB << "BLAH before"}
    m = @c.load(:id => 2233, :x=>123)
    m.save.must_equal m
  ...
  deprecated "#save should cancel the save and raise an error if before_validation calls cancel_action and raise_on_save_failure is true" do
  ...
  deprecated "#save should cancel the save and return nil if before_validation calls cancel_action and raise_on_save_failure is false" do
    @c.send(:define_method, :before_validation){cancel_action}
    @c.raise_on_save_failure = false
    @c.load(:id => 2233).save.must_be_nil
    DB.sqls.must_equal []
...
describe "Model around filters" do
  ...
  deprecated "around_create should be called around new record creation" do
    @c.class_eval do
      def around_create
        DB << 'ac_before'
        super
  ...
  deprecated "around_delete should be called around record destruction" do
    @c.class_eval do
      def around_destroy
        DB << 'ad_before'
        super
  ...
  deprecated "around_update should be called around updating existing records" do
    @c.class_eval do
      def around_update
        DB << 'au_before'
        super
  ...
  deprecated "around_save should be called around saving both new and existing records, around either after_create and after_update" do
    @c.class_eval do
      def around_update
        DB << 'au_before'
        super
  ...
  deprecated "around_validation should be called around validating records" do
    @c.class_eval do
  ...
  deprecated "around_validation should be able to catch validation errors and modify them" do
    @c.class_eval do
      def validate
        errors.add(:x, 'foo')
      end
  ...
  deprecated "around_create that doesn't call super should raise a HookFailed" do
    @c.send(:define_method, :around_create){}
    proc{@c.create(:x => 2)}.must_raise(Sequel::HookFailed)
  end
  
  deprecated "around_update that doesn't call super should raise a HookFailed" do
    @c.send(:define_method, :around_update){}
    proc{@c.load(:x => 2).save}.must_raise(Sequel::HookFailed)
  end
  
  deprecated "around_save that doesn't call super should raise a HookFailed" do
    @c.send(:define_method, :around_save){}
    proc{@c.create(:x => 2)}.must_raise(Sequel::HookFailed)
    proc{@c.load(:x => 2).save}.must_raise(Sequel::HookFailed)
  end
  
  deprecated "around_destroy that doesn't call super should raise a HookFailed" do
    @c.send(:define_method, :around_destroy){}
    proc{@c.load(:x => 2).destroy}.must_raise(Sequel::HookFailed)
  end
  
  deprecated "around_validation that doesn't call super should raise a HookFailed" do
    @c.send(:define_method, :around_validation){}
    proc{@c.new.save}.must_raise(Sequel::HookFailed)
  end

  deprecated "around_validation that doesn't call super should have valid? return false" do
    @c.send(:define_method, :around_validation){}
    @c.new.valid?.must_equal false
  end

  deprecated "around_* that doesn't call super should return nil if raise_on_save_failure is false" do
    @c.raise_on_save_failure = false
