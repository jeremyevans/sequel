...
describe Sequel::Database do
  specify "should correctly escape strings" do
    INTEGRATION_DB.get("\\dingo".as(:a)).should == "\\dingo"
  end
  ...
  specify "should correctly escape strings with backslash/carriage return/line feed" do
    [ "\\\n",
     "\\\\\n",
     "\\\r\n",
     "\\\\\r\n",
  ...
  specify "should properly escape binary data" do
    INTEGRATION_DB.get("\1\2\3".to_sequel_blob.as(:a)).should == "\1\2\3"
  end
