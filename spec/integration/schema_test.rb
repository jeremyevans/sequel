...
describe "Database schema modifiers" do
  ...
  cspecify "should create temporary tables without raising an exception", :fdbsql, [:jdbc, :fdbsql] do
  ...
  cspecify "should be able to specify constraint names for column constraints", :fdbsql, [:jdbc, :fdbsql] do
  ...
  cspecify "should work correctly with many operations in a single alter_table call", [:jdbc, :db2], [:db2], :fdbsql, [:jdbc, :fdbsql] do
    @db.create_table!(:items) do
      primary_key :id
      String :name2
      String :number2
