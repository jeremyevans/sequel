...
describe "pg_range extension" do
  ...
  it "should have friendly #inspect and #to_s output" do
    ...
    @R.new(1,2).to_s.must_equal "#<Sequel::Postgres::PGRange [1,2]>"
    @R.new(1,2, :exclude_begin=>true, :exclude_end=>true, :db_type=>'int4range').to_s.must_equal "#<Sequel::Postgres::PGRange (1,2)::int4range>"
    @R.new(nil, nil, :empty=>true).to_s.must_equal "#<Sequel::Postgres::PGRange empty>"
    @R.new(nil, nil, :empty=>true, :db_type=>'int4range').to_s.must_equal "#<Sequel::Postgres::PGRange empty::int4range>"
  end
