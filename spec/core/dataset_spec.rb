...
describe "Dataset#replace_select_with_alias" do
  ...
  specify "should do nothing if aliased columns are not present" do
    @d.select(:a).replace_select_with_alias(Sequel.as("4", :b)).sql.should == "SELECT a FROM test"
  end
  ...
  specify "should leave unaliased columns untouched" do
    @d.select(:a, :b).replace_select_with_alias(Sequel.as("1", :a)).sql.should == "SELECT b, '1' AS a FROM test"
  end

  specify "should accept a block that yields a virtual row" do
    @d.select(:a, :b).replace_select_with_alias { |o| Sequel.as("1", o.a) }.sql.should == "SELECT b, '1' AS a FROM test"
  end
end
