...
A model class wraps a dataset, and an instance of that class wraps a single record in the dataset. Unlike many other ORM systems, you do not define fields in your class definitions. Instead, Sequel obtains the field definitions from the database schema.
